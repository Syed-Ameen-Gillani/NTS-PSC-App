...
class _AccountSettingsScreenState extends State<AccountSettingsScreen> {
  ...
  Widget _buildSettingItem({
    ...
    final iconColor = isDestructive ? const Color(0xFFD32F2F) : const Color(0xFF1976D2);
    final iconBgColor = isDestructive ? const Color(0xFFFFEBEE) : const Color(0xFFE3F2FD);
    final titleColor = isDestructive ? const Color(0xFFD32F2F) : AppColors.onBackground;
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              if (trailing != null) trailing else Icon(Icons.chevron_right, color: isDestructive ? const Color(0xFFD32F2F) : AppColors.grey500, size: 20.w),
            ],
          ),
        ),
        if (showDivider)
          Padding(
            ...
            child: Divider(color: const Color(0xFFDADCE0), height: 1.h, thickness: 1.h),
          ),
      ],
    );
  }
